const translation = {
  ...
  PersonCredential: {
    ...
    ServicesCardInstalled: "Étape 1: L'application BC Services Card est installée",
    InstallServicesCard: "Étape 1: Installez l'application BC Services Card",
    InstallApp: "Installez l'application",
    AppOnOtherDevice: "Je l'ai dans un autre appareil",
    CreatePersonCred: "Étape 2: Créer votre attestation d'identité numérique gouvernemantale",
    StartProcess: 'Démarrez le processus',
  },
  StatusMessages: {
  ...
  Developer: {
    ...
    AttestationSupport: "Support d'attestation",
    CQEN: 'CQEN',
    MCN: 'MCN',
  },
