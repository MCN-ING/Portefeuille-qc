  ...
  History: {
    ...
    ConnectionRecord: {
      ...
      State: {
        ...
        'request-received': 'Requête reçue',
    ...
    CredentialRecord: {
      Title: "Ajout d'attestation",
      State: {
        'proposal-sent': 'Proposition envoyée',
        'proposal-received': 'Proposition reçue',
        'offer-sent': 'Offre envoyée',
        'offer-received': 'Offre reçue',
        declined: 'Refusée',
        'request-sent': 'Requête envoyée',
        'request-received': 'Requête reçue',
        'credential-issued': 'Attestation délivrée',
        'credential-received': 'Attestation reçue',
        done: 'Terminée',
      },
    },
    ProofRecord: {
      Title: 'Demande de preuve',
      State: {
        'proposal-sent': 'Proposition envoyée',
        'proposal-received': 'Proposition reçue',
        'request-sent': 'Requête envoyée',
        'request-received': 'Requête reçue',
        'presentation-sent': 'Présentation envoyée',
        'presentation-received': 'Présentation reçue',
        declined: 'Refusée',
        abandoned: 'Abandonnée',
        done: 'Terminée',
      },
