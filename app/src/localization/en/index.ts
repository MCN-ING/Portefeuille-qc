const translation = {
  ...
  Biometry: {
    ...
    EnabledText1: "  Log in with your phone's biometrics instead of your application PIN.",
    EnabledText1Bold:
      'Using biometrics means that all fingerprints or face ID added on this phone will have access to your wallet.',
    EnabledText2:
      'This means all fingerprint and facial data added on this phone can be used to access your application.',
    EnabledText3: 'Anyone who can access your phone with biometrics can access your QC Wallet.',
    EnabledText3Bold: 'Make sure only you have access to your application.',
    Warning: '\n\nMake sure only you have access to your application.',
    UseToUnlock: 'Use biometrics to unlock your application?',
  ...
  DefaultNotification: {
    PageTitle: 'Authentication Certificate',
    Title: 'Request your digital certificate of government attestation',
  ...
  PINCreate: {
    ...
    BulletPoint1: 'Configure your Government mobile identity application again',
    BulletPoint2: 'Re-apply for attestations already issued in your application',
    ...
    PinChangeSuccessMessage: 'Your PIN was successfully changed. You can now log in with your new PIN.',
    ...
    Message: {
      ...
      NoRepetitionOfTheSameNumbersValidation: 'Your PIN has a repetition (e.g. 111). Please choose a new one.',
      NoRepetitionOfTheTwoSameNumbersValidation:
        'A repeated two-digit sequence was detected in your PIN. Please try again.',
      NoSeriesOfNumbersValidation: 'Your PIN has a series (e.g. 123). Please choose a new one.',
      PINOnlyContainDigitsValidation: 'Your PIN must contain 6 digits. Please choose a new one.',
      PINTooShortValidation: 'Your PIN is too short. Please choose a new one.',
    ...
    ProgressBarText: '2. Securing the application',
  },
  PINEnter: {
    Title: 'Québec Wallet',
